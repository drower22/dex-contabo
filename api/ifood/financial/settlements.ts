...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    // Chama API iFood para settlements
    const url = `${IFOOD_BASE_URL}/financial/v3/settlements?merchantId=${merchantId}&beginPaymentDate=${from}&endPaymentDate=${to}`;
    ...
    console.error('[settlements] Exception:', e);
